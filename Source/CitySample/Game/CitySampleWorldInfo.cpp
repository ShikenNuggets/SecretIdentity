...
void ACitySampleWorldInfo::BeginPlay()
{
	Super::BeginPlay();
...
void ACitySampleWorldInfo::InitializeMapSceneCapture()
{
	...
	ACitySampleWorldInfo::CalculateTopWorldView(CustomViewProjectionMatrix, MapBounds, ViewportWidth, ViewportHeight);
...
void ACitySampleWorldInfo::CalculateTopWorldView(FMatrix& OutProjectionMatrix, const FBox& WorldBox, uint32 ViewportWidth, uint32 ViewportHeight)
{
...
void ACitySampleWorldInfo::InitializeSunlightSettings()
{
...
void ACitySampleWorldInfo::SetSunlightAngle(const float Angle)
{
...
void ACitySampleWorldInfo::ResetSunlightAngle()
{
	SetSunlightAngle(InitialSunlightYaw);
}

float ACitySampleWorldInfo::GetPostProcessingFilterBlendWeight() const
{
	return PostProcessingFilter.IsValid() ? PostProcessingFilter->BlendWeight : 0.0f;
}

void ACitySampleWorldInfo::SetPostProcessingFilterBlendWeight(const float BlendWeight)
{
